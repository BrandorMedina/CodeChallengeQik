...
exports.InitialSchema1774288441091 = void 0;
class InitialSchema1774288441091 {
    name = 'InitialSchema1774288441091';
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "exchange_rates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "rate" numeric(18,6) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "from_currency_id" uuid, "to_currency_id" uuid, CONSTRAINT "PK_33a614bad9e61956079d817ebe2" PRIMARY KEY ("id"))`);
...
exports.InitialSchema1774288441091 = InitialSchema1774288441091;
//# sourceMappingURL=1774288441091-InitialSchema.js.map